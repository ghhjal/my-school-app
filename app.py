                        ...
                        <head>
                            ...
                            <style>
                                * {{ box-sizing: border-box; }}
                                ...
                                /* ✳️ تصغير خط المقدمة وتوحيده */
                                p.intro {{ 
                                    font-family: 'Cairo', sans-serif; font-size: 22px; color: #193b68; 
                                    margin-bottom: 10px; 
                                }}
                                ...
                                /* ✳️ ختم جديد كصورة SVG لمنع التبعثر نهائياً */
                                .stamp-wrapper {{
                                    display: flex; justify-content: center; align-items: center;
                                    margin-bottom: 10px;
                                }}
