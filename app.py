...
# --- 1. إعدادات الصفحة والتحسين البصري الشامل ---
st.set_page_config(page_title="منصة الأستاذ زياد المعمري", layout="wide", initial_sidebar_state="expanded")

# تصميم CSS مخصص لرفع درجة وضوح النصوص في الجوال
st.markdown("""
    <style>
    /* تحسين البطاقات لتكون واضحة تماماً على خلفية الجوال */
