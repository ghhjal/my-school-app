...
def show_footer():
    """دالة عرض قنوات التواصل والحقوق (حل خطأ NameError)"""
...
# ==========================================
# 🎨 2. التصميم البصري (الهيدر، الحقول، القبعة)
# ==========================================
st.markdown("""
    <style>
    ...
    /* الهيدر الملكي: ضبط الهامش لظهور القبعة بوضوح */
    .header-container {
