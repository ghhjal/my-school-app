...
# --- القائمة الجانبية مع إشراف الأستاذ زياد ---
with st.sidebar:
...
# --- 4. واجهة الطالب (بيانات الطالب + تلوين السلوك) ---
    ...
    if not my_beh.empty:
        for i, row in my_beh.iterrows():
            # تلوين السلوك: أخضر للإيجابي وأحمر للسلبي
